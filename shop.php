...
<div class="content open" id="shop" style="z-index: 2;">
  <div class="menu">
        <ul>
            <li id="mainpage"><img src="img/menu.svg" class="menu-img"></li>
            <li id="boardpage"><img src="img/files-and-folders.svg" alt=""></li>
            <li id="click"><svg xmlns="http://www.w3.org/2000/svg" width="30.74" height="30.02" viewBox="0 0 28.62 27.976" class="menu-img">
            ...
            <li><img src="img/man-avatar.svg" class="menu-img"></li>
        </ul>
